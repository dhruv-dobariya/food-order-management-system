            ...
            <div className='login-popup'>
                <form onSubmit={onLogin} className='login-popup-container'>
                    ...
                    <div className="login-popup-inputs">
                        ...
                        <input name='password' onChange={onChangeHandler} type="password" placeholder='passwod' required />
                    ...
                    {currState === "Login"
                        ? <p>Create a new account? <span onClick={() => setCurrState("Sign Up")}>Click heare</span></p>
